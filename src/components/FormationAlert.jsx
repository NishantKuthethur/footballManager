...
export default function FormationAlert() {
  ...
  return (
    <div className="fixed w-fit h-[127px] rounded-lg p-6 bg-neutral-2 left-[489px] top-[320px] gap-2">
        ...
        <p className="w-[331px] text-[14px] leading-[22px] font-normal text-texts-normal text-center">{formationAlert.message}</p>
    </div>
  )
}
